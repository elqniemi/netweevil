...
class NetweevilDock(QDockWidget):
    ...
    def _build_simulation_tab(self):
        ...
        self.sim_zone_layer_combo.setFilters(QgsMapLayerProxyModel.PolygonLayer)
    ...
    def sim_show_frame(self, index):
        ...
        if index not in self.sim_frame_cache:
            try:
                ...
                self.log("Frame fetch failed: {}".format(exc), Qgis.Warning)
                return
    ...
    # --- congestion / busy segment layers -------------------------------

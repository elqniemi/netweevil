#!/usr/bin/env python3
"""Extract Groningen study origins and POIs from the full OSM PBF.
...
FULL_OSM = REPO_DIR / "datasets/groningen-260508.osm.pbf"
...
def import_h3():
    try:
        ...
        raise SystemExit(
            ...
            "`uv run --project projects-analyses/groningen-15-minute-city python "
            "projects-analyses/groningen-15-minute-city/scripts/extract_osm_features.py`."
        ) from error
    return h3

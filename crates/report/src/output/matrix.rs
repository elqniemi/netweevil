...
pub(super) fn write_matrix_gpkg(
    ...
    for cell in &result.cells {
        ...
        let mut fields = vec![
            ...
            ("source_lon", SqlValue::Real(origin.lon)),
            ("source_lat", SqlValue::Real(origin.lat)),
            ("target_lon", SqlValue::Real(destination.lon)),
            ("target_lat", SqlValue::Real(destination.lat)),
            (
                "status",
